...
-- esperado (pickup_at antes de 2009-01-01, quando a TLC começou a
-- disponibilizar dados eletrônicos, ou no futuro).
--
...
rejeitados as (
    ...
    where tpep_pickup_datetime is not null
      and (
          tpep_pickup_datetime < cast('2009-01-01' as timestamp)
          or tpep_pickup_datetime > current_date()
      )
